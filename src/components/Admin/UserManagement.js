        ...
        <div className="modal-overlay">
          <div className="modal">
            ...
            <div className="modal-actions">
              <button onClick={editingUser ? handleEditUser : handleCreateUser} className="btn-primary">
                {editingUser ? 'Update' : 'Create'}
              </button>
              <button onClick={() => { setShowCreateForm(false); setEditingUser(null); resetForm(); }} className="btn-secondary">
                Cancel
              </button>
            </div>
          </div>
